...
A composite action used by Storm Software repositories to setup a CI environment using [devenv](https://devenv.sh/).
...
the root repo directory (/action-devenv-setup).
